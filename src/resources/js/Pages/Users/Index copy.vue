...
const searchClear = () => {
    ...
    // サーバーサイドのセッションも更新するためにInertiaリクエストを送信
                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex pb-5 pl-5 my-4 lg:w-2/3 w-full mx-auto">
                                    ...
                                    <button class="bg-blue-300 text-white py-2 px-2 mx-2 w-20 rounded"
                                        @click="searchUser">検索</button>
                                    <button class="bg-red-300 text-white py-2 px-2 mx-2 w-20 rounded"
                                        @click="searchClear">クリア</button>
                                </div>
                                <!-- ユーザ一覧 -->
